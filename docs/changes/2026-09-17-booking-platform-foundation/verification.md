...
| AC-9 | pendiente | CI ya bloquea con checks en rojo (harness fail en el PR #2), pero falta activar la protección de rama (tarea 16) y el PR de prueba con un test roto (tarea 17); ambas requieren permisos de administrador |
